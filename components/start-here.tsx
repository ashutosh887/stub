  ...
  return (
    <section className="rounded-2xl border border-brand-dim bg-brand/[0.06] p-6">
      <div className="flex flex-wrap items-center justify-between gap-3">
        <div>
          <h2 className="font-display text-lg font-semibold text-fg">New here? Try it in 60 seconds.</h2>
      ...
      <ol className="mt-4 grid gap-3 sm:grid-cols-3">
        <Step n="1" head="Run a spend" body="Authorize a small amount below — it commits to the ledger instantly." />
        <Step n="2" head="Trip a limit" body="Spend more than an agent has left. It's denied, and the balance holds." />
        <Step n="3" head="Ask the ledger" body="Ask a question in plain English and get an answer from the entries." />
      </ol>
    </section>
  );
}
