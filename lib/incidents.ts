...
export const SCENARIOS: Scenario[] = [
  {
    ...
    headline: "In the wild this pattern burned ~$437 across 14,000 redundant calls before a quota tripped.",
    budgetUsd: 1.5,
    perCallUsd: 0.25,
    calls: 30,
  },
  ...
  },
  {
    ...
    headline: "One documented storm reached 847,000 calls and ~$3,847 before the account was suspended.",
    budgetUsd: 1.0,
    perCallUsd: 0.2,
    calls: 32,
  },
